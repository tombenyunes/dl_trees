...
python3 /scratch/gan/stylegan2-ada-pytorch/generate.py --outdir=/scratch/gan/output --trunc=1 --seeds=`shuf -i 1-10000 -n 1` --network=/scratch/gan/models/network-snapshot-000120.pkl